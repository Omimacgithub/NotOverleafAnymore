...
{
    name=Cuantización,
    description={En el área del aprendizaje máquina, es el proceso de reducir la precisión de un \gls{tensor}, generalmente de un formato de mayor precisión a uno de menor precisión. Esta técnica es de gran importancia, sobretodo en sistemas embebidos, debido a los elevados requerimientos computacionales y de memoria de los modelos de inteligencia artificial cuando se ejecutan en precisiones altas (ejemplo: \acrshort{fp}32).}
}