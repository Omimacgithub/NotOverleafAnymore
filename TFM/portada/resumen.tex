...
\begin{abstract}
    ...
    El software se ha adaptado para funcionar en la familia de placas NVIDIA Jetson y otros dispositivos relacionados (GeForce GTX y RTX). Se ha analizado el rendimiento de los modelos de detección y reconocimiento en varios motores de inferencia como OpenVino y TensorRT.

    Las pruebas se han realizado a partir de muestras (videos etiquetados) de un entorno de operación real, con movimientos bruscos de las cámaras y entrecruzado de los individuos. Se analiza la escalabilidad del sistema agregando más cámaras.

    Finalmente, se realiza un estudio de las diferentes opciones que existen para proteger los datos biométricos de los individuos que se agregan al sistema. Se han reportado resultados de la opción que resultó más viable implementar según las condiciones del proyecto.
