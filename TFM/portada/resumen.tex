...
\begin{abstract}
    ...
    Todas las pruebas se han realizado a partir de muestras (videos etiquetados) obtenidas en un entorno real de operación, con movimientos bruscos de las cámaras y entrecruzado de los individuos.
