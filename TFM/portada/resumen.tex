...
\begin{abstract}
    ...
    El software se ha adaptado para funcionar en la familia de placas NVIDIA Jetson y otros dispositivos relacionados (GeForce GTX y RTX). Se ha analizado el rendimiento de los modelos de detección y reconocimiento en software pensado para ejecutar inferencias optimizadas como OpenVINO y TensorRT en dichos dispositivos. Adicionalmente, se ha medido el rendimiento del sistema completo en tiempo real y su escalabilidad en función del número de cámaras y de nodos que procesan sus datos.
