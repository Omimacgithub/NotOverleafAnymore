...
El postprocesado de YOLO se ha optimizado para aprovechar los arrays y operaciones de NumPy. Los dispositivos Jetson agradecen especialmente esta mejora, que ha conseguido recortar hasta \textbf{22.3 milisegundos} en la Jetson Orin Nano (los resultados de inferencia reportaron una media de 44.4 milisegundos).
