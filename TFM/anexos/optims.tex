...
El código \ref{coud:preosnet} muestra un extracto de la función \textit{forward} del modelo en el que se muestran las operaciones del preprocesado. Se han tenido que intercambiar funciones de OpenCV por alternativas integradas de los arrays de NumPy (ejemplo: cvtColor por permute), el reescalado de la imagen (cv2.resize) se ha dejado en el código de la inferencia.
...
La ejecución del preprocesado en \acrshort{gpu} ha supuesto una mejora de aproximadamente \textbf{1 milisegundo} en la ejecución.
