...
TODO: Introducción?: El módulo de reconocimiento adaptativo se encarga de devolver las predicciones y actualizar el conocimiento existente a partir de la lista de entidades generada (ver sección \ref{sec:video}).
...
En la figura \ref{fig:ADAPTSYS} se muestra la arquitectura de este módulo. El módulo de reconocimiento adaptativo se compone de los siguientes componentes:
\begin{itemize}
