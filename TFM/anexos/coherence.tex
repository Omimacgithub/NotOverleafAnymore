...
\lettrine{E}{n} este apéndice se expone la implementación de un método para contrastar las detecciones de múltiples cámaras con base en la coherencia espacio-temporal.
