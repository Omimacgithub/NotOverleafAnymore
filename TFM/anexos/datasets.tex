...
Con el fin de evaluar el rendimiento del sistema en términos de precisión, se dispone principalmente de 2 \glspl{dataset}, uno que contiene el \gls{gt} para evaluar el nodo cámara y el otro para evaluar el nodo integración de sensores. A continuación se explican los detalles de ambos.
