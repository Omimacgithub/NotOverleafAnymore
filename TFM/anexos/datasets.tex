...
\lettrine{E}{n} este apéndice se exponen los elementos que conforman los \glspl{dataset} de las pruebas de los capítulos \ref{chap:cnn}, \ref{chap:syscal} y \ref{chap:systesting}. Con el fin de evaluar el rendimiento del sistema en términos de precisión, se dispone principalmente de dos \glspl{dataset} en formato \acrshort{json}, uno que contiene el \gls{gt} para evaluar el nodo cámara y el otro para evaluar el nodo integración de sensores. A continuación se explican los detalles de ambos.
...
\begin{itemize}
    ...
    \item \textit{\textbf{input}}: ruta al vídeo generado por la cámara.
\end{itemize}
