...
\lettrine{E}{n} este apéndice se presentan algunas de las métricas ampliamente reconocidas para evaluar modelos dentro del campo de la visión artificial.
...
A continuación se exponen las métricas, que hacen uso de los componentes ya comentados, para evaluar los modelos de detección y reconocimiento.
