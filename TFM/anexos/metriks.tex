...
Estos componentes se aplicarán a los \glspl{dataset} de prueba formados a partir de los vídeos grabados. En un entorno real de operación no sería posible aplicar dichas métricas por falta de un \textit{\gls{gt}}.
