...
El código \ref{coud:yolexport} se muestra un ejemplo de como exportar el modelo YOLO de ultralytics. Se descarga el archivo de pesos (.pt) y se exporta a \acrshort{onnx}, con un tamaño de batch de 1 y precisión de 16 bits de punto flotante (flag \textit{half}).