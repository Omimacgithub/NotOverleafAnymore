...
\begin{itemize}
    ...
    \item \textbf{Pruebas de los modelos y del sistema}: fue la tarea que más retrasó el proyecto. Los modelos en un principio reportaban bajas precisiones al implementarlos en \acrshort{gpu}. La mala exportación de los modelos o el pipeline de procesado de las imágenes eran las principales causas. Adicionalmente, las peculiaridades de cada arquitectura generaron problemas inesperados TODO: por ejemplo, al momento de exportar el modelo YOLO11n a \acrshort{onnx}. En todos los dispositivos, el modelo se exporta sin problema utilizando PyTorch en \acrshort{cpu}, a excepción de la Jetson AGX Orin, cuya exportación se realizó a partir de la versión de PyTorch para \acrshort{gpu}.
