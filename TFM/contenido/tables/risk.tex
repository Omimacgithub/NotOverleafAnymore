\begin{table}[tbp]
    ...
    \begin{tabular}{|p{4.5cm}|>{\centering\arraybackslash}p{1.9cm}|>{\centering\arraybackslash}p{1.6cm}|p{4.5cm}|}
        ...
        \hline
        \textit{Los componentes del sistema no son migrables a ROS 2} & 6                            & 1                          & estudiar implementaciones alternativas o adaptar el sistema para funcionar sin esos componentes \\\hline
