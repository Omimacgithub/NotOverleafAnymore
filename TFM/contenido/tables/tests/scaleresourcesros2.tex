\begin{table}[tbp]
    ...
    \begin{tabular}{cc|cccc}
        \hline
        \multicolumn{2}{c|}{\multirow{3}{*}{\textit{\begin{tabular}[c]{@{}c@{}}Number of\\ cameras\end{tabular}}}}  & \multicolumn{4}{c}{\textit{Jetson family}}                                                                                                   \\
        ...
        \multicolumn{1}{c|}{\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}10\\ cameras \footnotemark[3]\end{tabular}}} & \textit{\%load}                            & -                                     & \multicolumn{1}{c|}{-}            & 67.0         & 66.0 \\ \cline{2-2}
        \multicolumn{1}{c|}{}                                                                                       & \textit{\%mem}                             & \multicolumn{2}{c|}{-}                & \multicolumn{2}{c}{9.5}                                 \\ \hline
    \end{tabular}
    \caption{Recursos utilizados por los dispositivos Jetson durante la ejecución del sistema (solo cámaras en \acrshort{ros} 2)}
