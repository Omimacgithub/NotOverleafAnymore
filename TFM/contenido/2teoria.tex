...
\begin{figure}[tbp]
    ...
    \caption[Clasificación en espacio \acrshort{2d} mediante el uso de las \acrshort{svm}]{Clasificación en espacio \acrshort{2d} mediante el uso de las \acrshort{svm}, figura extraída de \cite{svn}.}
    \label{fig:linsvm}
\end{figure}
