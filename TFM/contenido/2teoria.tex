...
Existen 3 tipos diferentes de reconocimiento que se aplicarán a lo largo de esta memoria y que son los siguientes:

\subsubsection{\textit{Closed-Set}}
Tipo de reconocimiento que opera en un conjunto \textbf{cerrado} de objetos, siendo en este caso personas registradas de antemano. Es el modo en el que trabaja el sistema base \cite{andrew}.

\subsubsection{\textit{Open-Set}}
...
\subsubsection{\textit{Open-World}}
