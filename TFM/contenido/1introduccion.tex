...
Este trabajo persigue la ejecución eficiente de un sistema compuesto por múltiples redes neuronales convolucionales, que amplían su conocimiento a partir de la información del entorno. Para lograr dichos objetivos, se han explorado múltiples campos de investigación que se exponen a continuación.
...
\subsection{Seguimiento de objetos en múltiples frames}
