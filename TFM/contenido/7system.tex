...
%TODO: la cola puede albergar hasta 100 mensajes, si acaso será que los resultados llegan con demasiado retraso debido a la alta demanda de cómputo del sistema (para 10 cámaras, se deben de procesar un total de 40 redes neuronales en 100 milisegundos) lo que hace que se pierdan los frames que no tengan espacio en la cola
...
La métrica \textit{det\_p} sufre la mayor caída a medida que se escala en el número de cámaras...
...
La precisión en la detección (\textit{det\_p}) empeora en la Jetson Orin Nano cuando se ejecutan 5 cámaras simultáneamente. Debido a la menor capacidad de procesamiento de este dispositivo, es de esperar que muchos de los mensajes procesados por los nodos cámara lleguen tarde al nodo integrador, que devuelve una posición desactualizada respecto al frame de referencia. En cambio, el \textit{det\_r} se mantiene constante. En el caso de la Jetson AGX Thor, los resultados se mantienen en la línea de la familia Intel, sin contar el bajo \textit{det\_r} causado por la ausencia del \acrshort{lidar}.
