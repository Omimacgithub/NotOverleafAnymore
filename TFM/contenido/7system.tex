...
En la métrica \textit{det\_r} se aprecia una ligera bajada, no muy clara en el portátil, al aumentar la cantidad de cámaras. . Sin embargo, la caída de rendimiento en ambos dispositivos \textbf{no es crítica} y permite atender a la mayoría de las peticiones, aunque los resultados reflejan una clara congestión en los nodos.

TODO: realizar pruebas aumentando el tamaño de la cola... debido a la alta demanda de cómputo del sistema (para 10 cámaras, se deben de procesar un total de 40 redes neuronales en 100 milisegundos) lo que hace que se pierdan los frames que no tengan espacio en la cola
...
En la tabla \ref{tab:scaleresourcesros2} se muestra la proporción de recursos utilizados en las pruebas del sistema en \acrshort{ros} 2. TODO: se expone la mediana de todas las lecturas de recursos en una ejecución completa del sistema. Se emplea la mediana, ya que es robusta frente a los picos de uso de recursos.
...
La Jetson AGX Thor sufre una caída en el \textit{det\_p} cuando se ejecutan 10 cámaras simultáneamente, atendiendo a la tabla \ref{tab:scaleresourcesros2} el principal problema puede deberse a la carga excesiva de la \acrshort{gpu}, que supone el cuello de botella de la ejecución del sistema.
