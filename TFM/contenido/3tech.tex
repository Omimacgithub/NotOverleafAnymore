...
\begin{figure}[tbp]
    \centering
    \includegraphics[width=0.6\linewidth]{imagenes/memcpy.jpg}
...
A continuación se nombran las librerías de Python empleadas en el proyecto (todas son de \textbf{código abierto}):
\begin{description}
