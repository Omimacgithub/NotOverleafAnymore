...
\begin{description}
    \item[PyCUDA] \cite{pycuda} Es un \gls{wrapper} que interacciona con el driver de \gls{CUDA}. Se ha utilizado principalmente para generar los contextos y reservar la memoria en la \acrshort{gpu}, con el propósito de realizar las inferencias de los modelos.
