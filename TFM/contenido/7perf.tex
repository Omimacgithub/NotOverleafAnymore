...
A la hora de compilar los modelos para su uso con TensorRT, se han aplicado los siguientes flags con \textit{trtexec} (\textbf{solo equipos Jetson}):
\begin{itemize}
    \item --\acrshort{fp}16: activa el uso de tácticas \acrshort{fp}32 y \acrshort{fp}16 en cada capa del modelo (se escoge la precisión que se ejecute más rápido). Se aplica en todos los dispositivos Jetson.
