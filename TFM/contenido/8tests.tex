...
La selección de los frames que conforman un nuevo comité es un factor crítico para el correcto funcionamiento del sistema. En la tabla \ref{tab:inittab} se comparan 3 técnicas de inicialización:
\begin{itemize}
