...
Todas las \glspl{cnn} de este proyecto utilizan OpenVINO (ver sección \ref{sec:sw}) salvo YuNet, que utiliza el motor de OpenCV (ver sección \ref{sec:sw}) en \gls{cpu}.
...
\input{contenido/tables/tabequips}
...
\section{Resultados del sistema final}

\section{Resultados del sistema adaptativo}
...
\subsection{Pruebas de inicialización}

\subsection{Solapamiento de secuencias: buffering}
...
\subsection{Número de IoI}
El número de IoI (o de entidades positivas) afecta directamente al reconocimiento mediante Weibull, ya que cuantas más entidades, más puntos definen la distribución, por lo tanto mejor definida está la función. TODO: se nos quedan cortas estas pruebas (no tenemos suficientes personas).
...
\subsection{Número de negativos}
...
\subsection{Umbral de Weibull (TW)}
...
\subsection{Tamaño de la plantilla}
...
\subsection{Tamaño de secuencia}
...
\subsection{Criterio de selección de frames para nuevas SVM}
...
\subsection{Criterio de favorabilidad}
...
\subsection{Creación de nuevos comités}
