...
Se ha realizado un análisis de la escalabilidad desde 2 hasta 10 cámaras, que es la cifra máxima a la que se ha aspirado sin experimentar una caída grave en el rendimiento. El sistema se ha probado en las distribuciones ROS 1 y ROS 2. Según el dispositivo, solo hay opción a ejecutar una de las distribuciones (ejemplo: dispositivos Jetson). Se discuten los resultados de rendimiento atendiendo a múltiples factores como los recursos utilizados.
...
\begin{figure}
    ...
    \caption{Ejecución de las pruebas del sistema}
