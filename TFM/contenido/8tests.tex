...
Atendiendo a la tabla \ref{tab:scaleresources}, los recursos de la \acrshort{gpu} se llevan al límite con 10 cámaras en el caso de los equipos de sobremesa.
...
Se puede apreciar como todos los dispositivos mantienen y en algunos casos superan los números obtenidos en \cite{andrew}, lo cual es especialmente relevante en el caso de la Jetson Orin Nano, con sólo 25 W de potencia y un procesador muy inferior a un Intel Core i5.
