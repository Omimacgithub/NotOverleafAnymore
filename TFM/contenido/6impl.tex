...
Debido a que la base de datos introduce latencia al sistema, especialmente si las escrituras son recurrentes, se ha adoptado otra alternativa que aproveche la red \acrshort{ros}. Los nodos cámara se CONTINUAR suscrben
