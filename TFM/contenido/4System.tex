...
\begin{itemize}
    \item Nodo cámara: recibe como fuente los datos de una cámara \textbf{\acrshort{rgbd}} y se encarga de detectar, reconocer y obtener la posición 3D de las personas que aparecen en la imagen.
...
En el campo de TinyML ya se han analizado varios modelos \cite{MITTAL2019428, rahmaniar2021real} y propuesto múltiples optimizaciones \cite{MITTAL2019428} para sistemas NVIDIA Jetson. Este proyecto utiliza el motor de inferencia TensorRT para lograr la ejecución eficiente del sistema en los dispositivos Jetson. El rendimiento esperado en tiempo real para el sistema son los \textbf{10 Hz} (o 10 FPS), por lo tanto, todos los nodos deben de funcionar a 10 Hz. Las NVIDIA Jetson sólo tienen que ocuparse de ejecutar los \textbf{nodos cámara a 10 Hz} y que otro equipo ejecute el nodo LiDAR e integrador del sistema.
