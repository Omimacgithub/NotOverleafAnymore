...
En el sistema de partida (ver sección \ref{sec:partarch}), el registro inicial de individuos no se modifica (modo \textit{Closed-Set}), por lo tanto no existe la necesidad de mantener una fuente centralizada de los datos y, en su lugar, se realizan copias para cada uno de los nodos.
