...
Como ya se comentó en la sección \ref{sec:incrtypes}, en el modo \textit{Open-World} el sistema añade nuevo conocimiento de forma incremental, adaptándose al nuevo contexto y realizando así mejores predicciones. Sin embargo, debido a las predicciones incorrectas del sistema (ejemplo: que una persona se detecte como desconocida cuando ya es conocida), puede ocurrir que se creen nuevos comités para un individuo ya registrado. Esto puede ser perjudicial debido a que las \acrshort{svm} se entrenarían con muestras del mismo individuo en los conjuntos positivo y negativo, lo que podría anular el poder discriminatorio de dichas \acrshort{svm}.
