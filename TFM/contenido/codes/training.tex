\begin{lstlisting}[language=Python, float=t, label=coud:training, caption=Código de entrenamiento de las SVM]
...
# d1: positive samples 
# unk: flag to mark if d1 samples belong to a unknown entity
