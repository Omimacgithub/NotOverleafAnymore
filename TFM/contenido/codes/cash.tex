\begin{lstlisting}[language=Python, float=t, label=coud:cash, caption={Recolección de mensajes de las cachés de los sensores (ROS 1), sección \ref{sec:scal}}, basicstyle=\footnotesize]
def process(self):
