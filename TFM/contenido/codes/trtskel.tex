\begin{lstlisting}[language=Python, caption=Esqueleto del código de las inferencias con TensorRT]
# Import common libs
import cv2
import numpy as np
...
class CNN_model:
    ...
    def infer(self, frame):
      ...
      try:
        ...
        #Post-procesing
        postprocesed_output = POSTPROCESING(outputs)
        return postprocesed_output
      finally:
        self.ctx.pop()
\end{lstlisting}
\label{coud:trtskel}